...
} = require("../middlewware/validation/user.validate");
const {
  uploadPicMiddleware,
  uploadCVMiddleware,
  uploadExperienceFileMiddleware,
  uploadUserDocumentsFileMiddleware,
  uploadUserDocumentsFileMiddlewares,
} = require("../middlewware/upload/user.upload");
